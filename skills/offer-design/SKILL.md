...
Maximize perceived offer value across four variables:
...
## Critical Rules
1. Never discount core software pricing without reducing scope or securing longer annual commitment terms.
2. Every guarantee must be accompanied by explicit, friction-free refund terms that are honored immediately upon request.
3. Scarcity and urgency claims must reflect real operational constraints, never fake countdown timers.
